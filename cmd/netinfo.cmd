...
if (isset($GLOBALS['netdata']['class'])) {	//doesn't work when the bot is connected over a znc
...
if (empty($GLOBALS['bversion'])) {
	sendserv("NOTICE $nick :\002Version            \002  v".$GLOBALS['bofficial']." (".$GLOBALS['bcodename'].")");
}
else {
	sendserv("NOTICE $nick :\002Version            \002  v".$GLOBALS['bofficial']." (".$GLOBALS['bcodename']."-".$GLOBALS['bversion'].")");
}
